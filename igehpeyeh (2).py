...
def GetFollowers(user_id, max_id, cookie) -> str:
    for y in user_id:
       try:
           HEADERS.update({'cookie': cookie,'x-csrftoken': re.search('csrftoken=(.*?);',cookie).group(1),'user-agent': 'Mozilla/5.0 (Linux; Android 7.1.1; SM-J510H Build/NMF26X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 37.0.0.21.97 Android (25/7.1.1; 320dpi; 720x1280; samsung; SM-J510H; j5x3g; qcom; ru_RU; 98288239)'})
...
def Get_id(name):
    for y in name.split(','):
        try:
            HEADERS.update({'user-agent': 'Mozilla/5.0 (Linux; Android 7.1.1; SM-J510H Build/NMF26X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 37.0.0.21.97 Android (25/7.1.1; 320dpi; 720x1280; samsung; SM-J510H; j5x3g; qcom; ru_RU; 98288239)'})
...
def UserAgent():
    ...
    ua1 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; Xiaomi; MI 5; gemini; qcom; ru_RU; {kode})'
    ua2 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; samsung; SM-A510F; a5xelte; samsungexynos7580; de_DE; {basa}; {kode})'
    ua3 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; OPPO; CPH2109; OP4BA5L1; qcom; {basa}; {kode})'
    ua4 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; Xiaomi/xiaomi; Xiaomi/xiaomi; Redmi Note 4; mido; qcom; ru_RU; {basa}; {kode})'
    ua5 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; samsung; SM-A520F; a5y17lte; samsungexynos7880; ru_RU; {basa}; {kode})'
    ua6 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; samsung; SM-G930F; herolte; samsungexynos8890; ru_UA; {basa}; {kode})'
    ua7 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; samsung; SM-G920F; zeroflte; samsungexynos7420; uk_UA; {basa}; {kode})'
    ua8 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; samsung; SM-A310F; a3xelte; samsungexynos7580; hu_HU; {basa}; {kode})'
    uaa = rc([ua1,ua2,ua3,ua4,ua5,ua6,ua7,ua8])
    return uaa
